exports.confirmationEmail = (patientName, appointmentDate, appointmentTime) => {
	return `<!DOCTYPE html>
<html lang="en">
<head>
   <meta charset="UTF-8" />
   <title>Appointment Confirmation — Our Clinic</title>
      ...
      <table class="main" role="presentation" cellpadding="0" cellspacing="0" width="100%">
         ...
         <tr>
            <td class="hero">
               ...
               <p class="subtitle">Dear ${patientName}, your appointment has been successfully booked.</p>
            </td>
         </tr>
         <tr>
            <td>
