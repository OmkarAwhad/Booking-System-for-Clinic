exports.feedbackEmail = (patientName) => {
	return `<!DOCTYPE html>
<html lang="en">
<head>
   <meta charset="UTF-8" />
   <title>Feedback Request — Our Clinic</title>
      ...
      <table class="main" role="presentation" cellpadding="0" cellspacing="0" width="100%">
         ...
         <tr>
            <td class="hero">
               ...
               <p class="subtitle">Dear ${patientName}, thank you for your recent visit!</p>
            </td>
         </tr>
         <tr>
            <td>
               <div class="card">
                  <div class="row">
                     ...
                     <span class="value">Please share your thoughts to help us improve our services.</span>
                  </div>
               </div>
            </td>
         </tr>
         ...
         <tr>
            <td class="note">
               Your feedback is important to us. If you have any questions, contact us at <a href="mailto:omkarawhad3007@gmail.com">support@bookingsystem.com</a>.
            </td>
         </tr>
         <tr>
            <td class="footer">
